...
@section("content")
    <div class="container-fluid">
        <h1 class="mt-4">Vitolas
            <div class="btn-group" role="group">
                <button class="btn btn-sm btn-success"
                        id="botonAbrirModalNuevaVitola"
                        data-toggle="modal" data-target="#modalCrearVitola">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Vitolas</li>
            </ol>
        ...
        @if(session("errores"))
            ...
            <script>
                document.onreadystatechange = function () {
                    if (document.readyState) {
                        document.getElementById("botonAbrirModalNuevaVitola").click();
                    }
                }
            </script>
            @endif
    @endif
        ...
        <table class="table">
            ...
            @if(!$vitola)
                <tr>
                    <td colspan="4" style="align-items: center">No hay Vitolas registradas</td>
                </tr>
            @endif
            @foreach($vitola as $marca)
                <tr>
                    <td>{{$noPagina++}}</td>
                    <td>{{$marca->name}}</td>
        ...
        <!-----------------MODAL CREAR MARCA--------------------------------------->
        <div class="modal fade" id="modalCrearVitola" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background: #2a2a35">
                        <h5 class="modal-title" style="color: white"><span class="fas fa-pencil-alt"></span> Agregar Vitola
                        </h5>
        ...
        <div class="modal fade" id="modalEditarMarca" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background: #2a2a35">
                        <h5 class="modal-title" style="color: white"><span class="fas fa-pencil-alt"></span> Editar Vitola
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span style="color: white" aria-hidden="true">&times;</span>
                        </button>
                ...
                <div class="modal-content">
                    <form method="post" action="{{route("vitolaBorrar")}}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <p>¿Estás seguro que deseas borrar la vitola <label
