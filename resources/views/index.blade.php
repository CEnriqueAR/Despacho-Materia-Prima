    ...
    <div class="home">
        <!-- Hero Slider -->
                ...
                <div class="hero_slide">
                    <div class="hero_slide_background" style="background-image:url(imagen/Login.png)"></div>
                    <div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
                        <div class="hero_slide_content text-center">
                            <h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOut">DESPACHO DE MATERIA PRIMA</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 hero_box_col">
                        ...
                        <div class="hero_box d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="hero_box_content">
                                ...
                                <a href="courses.html" class="hero_box_link">acceder</a>
                            </div>
                        </div>
                        </a>
                    </div>
...
<script src="styles/stylesindex/bootstrap4/bootstrap.min.js"></script>
...
<script src="js/jsindex/custom.js"></script>
