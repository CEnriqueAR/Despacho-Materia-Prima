...
@section("content")
                    ...
                    <div class="input-group" style="width: 300px">
                        ...
                        <div class="input-group-append">
                            <a id="borrarBusqueda" class="btn btn-danger hideClearSearch" style="color: white"
                               href="{{route("InventarioInicial")}}">&times;</a>
    ...
    <!--------------------------Reabrir modal si hay errror---------------------------->
        ...
        <table class="table">
            ...
            @endif
            @foreach($binicial as $marca)
                <tr>
                    <td>{{$noPagina++}}</td>
                    <td>{{$marca->nombre_marca}}</td>
                    <td>{{$marca->nombre_vitolas}}</td>
        ...
        <div class="modal fade" id="modalBorrarMarca" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <form method="post" action="{{route("InventarioInicialborrar")}}" enctype="multipart/form-data">
                        @method("DELETE")
                        @csrf
