...
@section("content")
    <div class="container-fluid">
        <h1 class="mt-4">Devoluciones De Bultos
            <div class="btn-group" role="group">

                <button class="btn btn-sm btn-success"
                        id="botonAbrirModalNuevoBultoDevuelto"
                        data-toggle="modal" data-target="#modalNuevoBultoDevuelto">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Devoluciones De Bulto</li>
                    ...
                    <div class="input-group" style="width: 300px">
                        ...
                        <div class="input-group-append">
                            <a id="borrarBusqueda" class="btn btn-danger hideClearSearch" style="color: white"
                               href="{{route("BultoDevuelto")}}">&times;</a>
        ...
        @if($errors->any())
            ...
            <script>
                document.onreadystatechange = function n(){
                    if (document.readyState){
                       document.getElementById("botonAbrirModalNuevoBultoDevuelto").click();
                    }
                }
            </script>
        @endif
        ...
        <table class="table">
            ...
            @endif
            @foreach($bultoDevuelto as $productos)
                <tr>
                    <td>{{$noPagina++}}</td>
...
<!----------------------------------------------------MODAL NUEVO PRODUCTO------------------------------------------------------->
    <div class="modal fade" id="modalNuevoBultoDevuelto" tabindex="-1" role="dialog">
    ...
    <div class="modal fade" id="modalEditarCapaEntrega" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="nuevoP" method="POST" action="{{route("BultoDevueltoeditar")}}" >
                    @method("PUT")
    ...
    <div class="modal fade" id="modalfecha" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="nuevoP" method="POST" action="{{route("exportarbultodevuelto")}}" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="modalfechapdf" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="nuevoP" method="POST" action="{{route("exportarbultodevueltopdf")}}" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="modalfechacvs" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="nuevoP" method="POST" action="{{route("exportarbultodevueltocvs")}}" enctype="multipart/form-data">
